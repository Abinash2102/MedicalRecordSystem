...
$pass = $_POST['pass'];
$category = dataFilter($_POST['category']); require '../db.php';
if($category == 1)
{
...
$_SESSION['message'] = "Invalid User Credentialss!"; header("location: error.php");
...
$_SESSION['message'] = "Invalid User Credentials!"; header("location: error.php");
